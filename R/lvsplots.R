lvsplot <- function(x, jitter = FALSE, biplot = TRUE, ind.spp = NULL, alpha = 0.5, main = NULL, 
     ...
     if(length(which.lvs) != 2) 
          stop("which.lvs should be a vector of length 2, indicating which axes to plot. This argument is ignored if x$num.lv = 1.")
     if(x$num.lv > 2 & any(which.lvs > x$num.lv)) 
